...
export default function TarotHome() {
  return (
    <Layout>
      <div className="w-full max-w-[384px] min-h-[783px] mx-auto relative bg-tarot overflow-hidden flex flex-col items-center gap-8 py-8">
        {/* 상단 텍스트 */}
        ...
        <Link
          to="/tarot/selection"
          className="w-80 p-2.5 bg-yellow-50 rounded-2xl outline outline-2 outline-offset-[-2px] outline-neutral-950 flex justify-center items-center gap-2.5 mt-auto"
        >
